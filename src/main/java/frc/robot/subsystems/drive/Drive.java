...
public class Drive extends SubsystemBase {
    ...
    public void runVelocityFF(ChassisSpeeds speeds, DriveFeedforwards ff) {
        runVelocity(speeds);
    }
    ...
    public void runVelocityTurnOut(ChassisSpeeds speeds) {
        // Calculate module setpoints
        ChassisSpeeds discreteSpeeds = ChassisSpeeds.discretize(speeds, 0.02);
        SwerveModuleState[] setpointStates;
    ...
    public void runVelocityTurretCenter(ChassisSpeeds speeds) {
        // Calculate module setpoints
        ChassisSpeeds discreteSpeeds = ChassisSpeeds.discretize(speeds, 0.02);
        SwerveModuleState[] setpointStates =
                kinematics.toSwerveModuleStates(discreteSpeeds, Constants.shooterLocOnBot);
        SwerveDriveKinematics.desaturateWheelSpeeds(setpointStates, TunerConstants.kSpeedAt12Volts);
    ...
    public boolean wontMiss(Shooter shooter, boolean isShooting) {
